...
namespace MF {
	namespace TriMesh {
		...
		struct CIterators : public CIteratorCore<typename MeshType::DType, typename MeshType::VType, typename MeshType::EType, typename MeshType::FType, typename MeshType::HEType>
		{};
	}
}